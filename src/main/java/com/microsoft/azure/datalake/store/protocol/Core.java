...
public class Core {
    ...
    /**
     * creates a directory, and all it's parent directories if required.
     *
     ...
     * <P>
     * a file that has both Acl's and permissions uses ta super-set of both to grant access, meaning that permission
     * is granted if user would have permission by either of those mechanisms.
     * </P>
     *
     *
